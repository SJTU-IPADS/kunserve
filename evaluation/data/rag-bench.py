...
if __name__ == '__main__':
    ...
    parser.add_argument('--local-dir', default='/data/dataset/rag-bench-llama')
    ...
    data_source = "rungalileo/ragbench"
    # add a row to each data item that represents a unique id
    train_dataset = concatenate_datasets([
        load_dataset(data_source, dataset, split='train', trust_remote_code=True)
    ...
    def make_map_fn(split):
        ...
        def process_fn(sample, idx):
            ...
            model_name = sample.pop('generation_model_name')
    ...
    model_names = list(set(train_df["model_name"]))
    print(f"{model_names=}")

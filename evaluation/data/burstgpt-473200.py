...
if __name__ == '__main__':
    ...
    parser.add_argument('--local-dir', default='/data/dataset/burstgpt-llama-473200')
    parser.add_argument('--tokenizer', default="deepseek-ai/DeepSeek-R1-Distill-Llama-70B")
    parser.add_argument('--limit', "-l", type=int, default=3000)
    parser.add_argument('--offset', "-o", type=int, default=473200)
    ...
    dataset = dataset.iloc[args.offset:args.offset + args.limit]
    ...
    for i, entry in tqdm(dataset.iterrows(), total=total):
        ...
        if len(prompt_token_ids) + response_len > 16384:

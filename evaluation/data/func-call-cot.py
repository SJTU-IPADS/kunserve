...
if __name__ == '__main__':
    ...
    parser.add_argument('--local-dir', default='/data/dataset/func-call-cot-llama')
    ...
    data_source = "ThinkAgents/Function-Calling-with-Chain-of-Thoughts"
    # add a row to each data item that represents a unique id
    train_dataset = load_dataset(data_source, split='train', trust_remote_code=True)

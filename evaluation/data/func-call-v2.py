...
if __name__ == '__main__':
    ...
    parser.add_argument('--local-dir', default='/data/dataset/func-call-v2-llama')
    ...
    data_source = "WhiteRabbitNeo/Code-Functions-Level-Cyber"
    ...
    def make_map_fn(split):
        ...
        def process_fn(sample, idx):
            question = sample.pop('instruction')

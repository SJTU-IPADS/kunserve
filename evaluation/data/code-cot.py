...
if __name__ == '__main__':
    ...
    parser.add_argument('--local-dir', default='/data/dataset/code-llama')
    ...
    data_source = "open-r1/codeforces-cots"
    dataset = datasets.load_dataset(data_source, 'solutions')
    ...
    def make_map_fn(split):
        ...
        def process_fn(sample, idx):
            ...
            response = sample.pop('generation')

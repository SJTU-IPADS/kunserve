...
to that of FlashTransformer.

This file follows the workflow described in
`../../FlashTransformer/scripts/lib/converter_lib.py`. Please refer to that file
...
This file is divided into four parts:
 ...
 - NameTranslators: They are used to convert the names of the weights from
     different models (e.g. LLaMA2) to the format used by FlashTransformer.
     ...
     of the weight in FlashTransformer (following OPT's naming convention)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Convert weights from other models to FlashTransformer's format")
